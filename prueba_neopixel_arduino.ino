...
Adafruit_NeoPixel tira = Adafruit_NeoPixel(15, 2, NEO_GRB + NEO_KHZ800);	// creacion de objeto "tira"
...
void loop(){
  ...
  for(int i = 0; i < 15; i++){		// bucle para recorrer posiciones 0 a 7
  ...
  for(int i = 14; i >= 0; i--){		// bucle para recorrer posiciones 7 a 0
